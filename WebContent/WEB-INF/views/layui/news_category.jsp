...
<h2><b>分类管理</b></h2><br>
 <div  class="demoTable">
  ...
  <button id="btn-add" class="layui-btn" >添加分类</button>
...
form.on('submit(add-submit)', function(data){
  ...
  $.post('newscategoryadd',data.field,
	function(data){
	  if(data.type == 'success'){
...
table.on('tool(test)', function(obj){
  ...
  table.render({
    elem: '#demo'
    ,url: 'newscategory' //数据接口
    ,page: true //开启分页
    ,cols: [[ //表头
       {field: 'id', title: '分类ID',type:'checkbox'}
      ,{field: 'name', title: '日志内容'}
      ,{field: 'sort', title: '排序'}
