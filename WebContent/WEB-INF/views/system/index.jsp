...
<meta name="copyright" content="All Rights Reserved, Copyright (C) 2013, 知享, Ltd." />
<title>后台管理主页</title>
...
<div id="loading" style="position:absolute;z-index:1000;top:0px;left:0px;width:100%;height:100%;background:#FFFFFF;text-align :center;padding-top:6%;">
     <img src="../resources/admin/easyui/images/loding.gif" width="50%">
</div> 
	<!-- begin of header -->
	<div class="wu-header" style="background:blue" data-options="region:'north',border:false,split:true">
    	<div class="wu-header-left">
        	<h1>【知享】后台管理系统</h1>
        </div>
        <div class="wu-header-right">
        	<p><strong class="easyui-tooltip" title="0条未读消息">${role.name}:${admin.username}</strong>，欢迎您！</p>
            <p><a href="index">网站首页</a>|<a href="logout">安全退出</a></p>
        </div>
    </div>
    <!-- end of header -->
    <!-- begin of sidebar -->
	...
	<div class="wu-footer" data-options="region:'south',border:true,split:true">
    	&copy; 2019 【知享】 All Rights Reserved
    </div>
    <!-- end of footer -->  
