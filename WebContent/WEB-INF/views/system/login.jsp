...
<div id="particles-js" style="background-image: url(../resources/admin/login/images/bg.gif)">
		<div class="login" style="display: block;">
			...
			<div class="login-button" style="background:red">
				登录
			</div>
		</div>
